...
func main() {
	...
	brokerAddress := "194.87.95.28:29092" // Адрес вашего внешнего Kafka-брокера
	topic := "emails"                     // Имя топика для чтения
	groupID := "email-reader-group"       // ID группы потребителей
